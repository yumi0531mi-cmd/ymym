...
VERSION = "v6.1-practical-scalp-core"
SCHEMA_VERSION = "v6.0-schema-1"
PLAN_VERSION = "v6.0-plan-1"
...
def data_freshness_plan(item,market,now_ts=None):
    ...
    # v6: 실시간 quote age가 확인되지 않으면 FINAL BUY 데이터품질을 통과시키지 않는다.
    q_known=q>=0; q_ok=q_known and q<=15
